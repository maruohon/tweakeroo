...
public enum FeatureToggle implements ConfigInfo
{
    ...
    TWEAK_AFTER_CLICKER                 ("tweakAfterClicker",                       false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_BREAKING_GRID                 ("tweakBreakingGrid",                       false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_BREAKING_RESTRICTION          ("tweakBreakingRestriction",                false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_FAST_BLOCK_PLACEMENT          ("tweakFastBlockPlacement",                 false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_FAST_LEFT_CLICK               ("tweakFastLeftClick",                      false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_FAST_RIGHT_CLICK              ("tweakFastRightClick",                     false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_FILL_CLONE_LIMIT              ("tweakFillCloneLimit",                     false),
    TWEAK_FLY_SPEED                     ("tweakFlySpeed",                           false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_FLEXIBLE_BLOCK_PLACEMENT      ("tweakFlexibleBlockPlacement",             false),
    TWEAK_FREE_CAMERA                   ("tweakFreeCamera",                         false),
    TWEAK_GAMMA_OVERRIDE                ("tweakGammaOverride",                      false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_HOTBAR_SLOT_CYCLE             ("tweakHotbarSlotCycle",                    false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_HOTBAR_SLOT_RANDOMIZER        ("tweakHotbarSlotRandomizer",               false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_PERIODIC_ATTACK               ("tweakPeriodicAttack",                     false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_PERIODIC_USE                  ("tweakPeriodicUse",                        false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_PLACEMENT_GRID                ("tweakPlacementGrid",                      false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_PLACEMENT_LIMIT               ("tweakPlacementLimit",                     false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_SNAP_AIM                      ("tweakSnapAim",                            false, KeyBindSettings.INGAME_RELEASE),
    TWEAK_SNAP_AIM_LOCK                 ("tweakSnapAimLock",                        false),
    TWEAK_SPECTATOR_TELEPORT            ("tweakSpectatorTeleport",                  false),
    TWEAK_STATIC_FOV                    ("tweakStaticFov",                          false, KeyBindSettings.INGAME_RELEASE),
    ...
    TWEAK_ZOOM                          ("tweakZoom",                               false, KeyBindSettings.INGAME_RELEASE);
