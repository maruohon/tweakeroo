...
import fi.dy.masa.tweakeroo.config.gui.button.ConfigButtonBoolean;
import fi.dy.masa.tweakeroo.config.gui.button.ConfigButtonOptionList;
...
{
    private final TweakerooConfigPanel parent;
    ...
    public ConfigPanelSub(String title, TweakerooConfigPanel parent)
    {
        this.title = title;
        this.parent = parent;
    }
