...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_NO_ENTITY_TICKING         ("tweakNoEntityTicking",                false, true, "",    "Prevent everything except player entities from getting ticked"),
    ...
    TWEAK_NO_TILE_ENTITY_TICKING    ("tweakNoTileEntityTicking",            false, true, "",    "Prevent all TileEntities from getting ticked"),
