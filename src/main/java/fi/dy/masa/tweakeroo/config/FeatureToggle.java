...
public enum FeatureToggle implements IConfigBoolean, IHotkey
{
    ...
    TWEAK_AFTER_CLICKER             ("tweakAfterClicker",                   false, "X,A", "Enables a \"after clicker\" tweak, which does automatic right clicks on the just-placed block.\nUseful for example for Repeaters (setting the delay)."),
    ...
    TWEAK_HOTBAR_SLOT_CYCLE         ("tweakHotbarSlotCycle",                false, "X,C", "Enables cycling the hotbar slot after each placed block, up to the set max slot number"),
