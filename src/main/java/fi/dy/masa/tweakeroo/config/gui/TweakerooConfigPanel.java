...
public class TweakerooConfigPanel extends AbstractConfigPanel
{
    ...
    {
        private final TweakerooConfigPanel mainPanel;

        public ButtonListenerPanelSelection(TweakerooConfigPanel mainPanel)
        {
