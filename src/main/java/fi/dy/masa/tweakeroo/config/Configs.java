...
public class Configs implements IConfigHandler
{
    ...
    public static class Disable
    {
        ...
        public static final ConfigBooleanHotkeyed       DISABLE_SIGN_EDIT               = new ConfigBooleanHotkeyed("disableSignEdit",                      false, "", "Disables the sign editing when right clicking on a sign");
