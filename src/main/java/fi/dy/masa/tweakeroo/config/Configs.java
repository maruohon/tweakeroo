...
public class Configs implements IConfigHandler
{
    public static class Generic
    {
        ...
        public static final ConfigBoolean       SLOT_SYNC_WORKAROUND_ALWAYS         = new ConfigBoolean     ("slotSyncWorkaroundAlways", false, "Enables the slot sync workaround at all times when the use key is held,\nnot only when using fast right click or fast block placement.\nThis is mainly for other mods that may quickly use items when holding down use,\nsuch as Litematica's Easy Place mode.");
