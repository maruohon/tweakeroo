...
public class Configs implements IConfigHandler
{
    ...
    public static class Fixes
    {
        ...
        public static final ConfigBoolean TNT_ON_SOULSAND_LIGHTING_FIX = new ConfigBoolean("entityOnSoulsandLightingFix", false, "Fixes entities as tnt rendering black on soulsand ");
