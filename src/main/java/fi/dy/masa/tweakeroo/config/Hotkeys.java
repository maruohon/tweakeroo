...
{
    public static final ConfigHotkey ACCURATE_BLOCK_PLACEMENT_IN        = new ConfigHotkey("accurateBlockPlacementInto",        "LMENU",    KeybindSettings.PRESS_ALLOWEXTRA, "The key to activate the accurate block placement mode/overlay\nfor placing the block facing into the clicked block face");
    public static final ConfigHotkey ACCURATE_BLOCK_PLACEMENT_REVERSE   = new ConfigHotkey("accurateBlockPlacementReverse",     "LCONTROL", KeybindSettings.PRESS_ALLOWEXTRA, "The key to activate the accurate block placement mode/overlay\nfor placing the block facing the opposite way from what it would normally be");
    ...
    public static final ConfigHotkey HOTBAR_SCROLL                      = new ConfigHotkey("hotbarScroll",                      "V",        KeybindSettings.PRESS_ALLOWEXTRA, "The key to hold to allow scrolling the hotbar through the player inventory rows");
